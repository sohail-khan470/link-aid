...
export default function TowingStaffManagement() {
  ...
  const [selectedRole, setSelectedRole] = useState("tow_operator");
  const [editRowId, setEditRowId] = useState<string | null>(null);
  const [editRole, setEditRole] = useState<string>("tow_operator");
        ...
        {userData && (
          <div className="border rounded-xl bg-white dark:bg-white/5 dark:border-white/10 p-6 mb-6 shadow-sm transition-all">
            ...
            <div className="mt-5">
              ...
              >
                <option value="tow_operator" className="dark:bg-gray-700">
                  Tow Operator
                </option>
